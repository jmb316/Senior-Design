...
// Fill table with data
function populateChapSignup() {
    
    // Empty content string
    var tableContent = '';
    
    // jQuery AJAX call for JSON
    $.getJSON( '/chaptersignup', function( data ) {
              ...
              $.each(data, function(){
                     tableContent += '<tr>';
                     tableContent += '<td><a href="#" class="linkshowchapter" rel="' + this.school+ '" title="Show Details">' + this.username + '</a></td>';
                     tableContent += '<td>' + this.email + '</td>';
                     tableContent += '<td><a href="#" class="linkdeletechapter" rel="' + this._id + '">delete</a></td>';
                     tableContent += '</tr>';
                     });
