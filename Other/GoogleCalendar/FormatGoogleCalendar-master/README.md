...
formatGoogleCalendar.init({<br>
        calendarUrl: 'https://www.googleapis.com/calendar/v3/calendars/ftbioqlsgdfcp0sltprr7r7nqg@group.calendar.google.com/events?key=AIzaSyCR3-ptjHE-_douJsn8o20oRwkxt-zHStY',<br>
        past: false,<br>
        upcoming: true,<br>
        pastTopN: -1,<br>
        upcomingTopN: 3,<br>
        ...
        upcomingHeading: '&lt;h2&gt;Upcoming eventsg&lt;/h2&gt;',<br>
